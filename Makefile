...
BINARY		= main
SRCFILES	= main.c usart1.c usart3.c spi2.c nrf24.c miniprintf.c vesc/crc.c vesc/buffer.c vesc/vesc.c rtos/heap_4.c rtos/list.c rtos/port.c rtos/queue.c rtos/tasks.c rtos/opencm3.c
